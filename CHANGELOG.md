...
* [#305](https://github.com/nghuuphuoc/bootstrapvalidator/pull/305), [#306](https://github.com/nghuuphuoc/bootstrapvalidator/pull/306), [#307](https://github.com/nghuuphuoc/bootstrapvalidator/pull/307): Fix ```inclusive``` option in the [```between``` validator](http://bootstrapvalidator.com/validators/between/), [```greaterThan``` validator](http://bootstrapvalidator.com/validators/greaterThan/) and [```lessThan``` validator](http://bootstrapvalidator.com/validators/lessThan/), thanks to [@johanronn77](https://github.com/johanronn77)
