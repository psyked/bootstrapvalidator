(function($) {
    ...
    $.fn.bootstrapValidator.i18n = $.extend(true, $.fn.bootstrapValidator.i18n, {
        ...
        id: {
            ...
            country: 'لطفا یک شماره شناسایی  %s صحیح وارد فرمایید',
            countries: {
                BA: 'بوسنی و هرزگوین',
                BG: 'بلغارستان',
                BR: 'برزیل',
        ...
        identical: {
            'default': 'لطفا عبارت یکسان وارد فرمایید'
        },
        imei: {
        ...
        notEmpty: {
            'default': 'لطفا یک عبارت وارد فرمایید'
        },
        numeric: {
        ...
        vat: {
            ...
            countryNotSupported: 'کد کشور %s پشتیبانی نمیگردد',
            country: 'لطفا یک مقدار %s شماره VAT صحیح وارد فرمایید',
            countries: {
                AT: 'اتریش',
                BE: 'بلژیک',
                BG: 'بلغارستان',
        ...
        zipCode: {
            ...
            countryNotSupported: 'کد کشور %s پشتیبانی نمیگردد',
            country: 'لطفا یک %s صحیح وارد فرمایید',
            countries: {
                BR: 'کدپستی برزیل',
                CA: 'کدپستی کانادا',
                DK: 'کدپستی دانمارکی',
